...
const Footer = () => {
  return (
    <div className="flex p-10 dark:bg-slate-700 dark:text-white ">
      <div id="1" className="flex flex-col  justify-center items-center w-1/4">
      ...
      <div id="2" className="flex flex-col w-1/4 justify-center items-center">
        <p className='title'>دسترسی سریع</p>
        <a href="">قوانین و مقررات</a>
        <a href="">ارسال تیکت</a>
        <a href="">همه ی دوره ها </a>
      </div>
      <div id="3" className="flex flex-col w-1/4 justify-center items-center">
      ...
      <div id="4" className="flex flex-col w-1/4 justify-center items-center">
